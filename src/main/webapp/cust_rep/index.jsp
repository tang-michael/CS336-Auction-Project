    ...
    <div class="container">
        ...
        <div style="margin-top: 2rem;">
            ...
            <div style="padding: 2rem;border: 1px solid lightgray; margin-top: 1rem;">
                ...
                <div>
                    <div style="font-size: .9rem;display: flex;justify-content: space-between;align-items: center">
                        <a href="answers.jsp?questionId=<%=question.getQuestionId()%>">
                            <span class="text-bold">Answers</span>
                        </a>
                        <a style="text-decoration: none" href="answer_question.jsp?questionId=<%=question.getQuestionId()%>" class="btn btn-primary">Answer</a>
                    </div>
                </div>
            </div>
            <% } %>
