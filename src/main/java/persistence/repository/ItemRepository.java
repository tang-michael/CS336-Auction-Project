...
/**
 * Class that manipulates the "cameras", "phones", "computers", "computer_accessories", "item"
 * tables.
 */
public class ItemRepository extends Repository {
    ...
    public void deleteItem(int itemId) throws SQLException {
        List<String> tables = Arrays.asList("cameras", "phones", "computers", "computer_accessories", "has_item", "item");
    ...
    // Convert an Item to a ComputerAccessory object if the Item is a computer accessory
    // as verified in the database.
